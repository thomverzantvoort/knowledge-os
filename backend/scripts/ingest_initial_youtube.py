...
from app.ingest.runner import run_initial_ingest

logger = logging.getLogger(__name__)


def _print_sync_results(results: list[SyncSubscriptionResult]) -> None:
    print("Initial ingest complete")
    print("  window_hours:", settings.ingest_initial_window_hours)
...
if __name__ == "__main__":
    ...
    _print_sync_results(run_initial_ingest())
